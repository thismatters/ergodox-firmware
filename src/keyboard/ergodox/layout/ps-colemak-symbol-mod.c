...
Layer 1: Symbols
Layer 2: Qwerty
Layer 3: Numpad (two-hand)
Layer 4: Mypaint
Layer 5: Qwerty Reversed (Mirrorboard)
*/
...
const uint8_t PROGMEM _kb_layout[KB_LAYERS][KB_ROWS][KB_COLUMNS] = {
    ...
    _ctrlR,    _A, _S,      _D,     _F,  _E,
    _shiftL, _Z, _Y,      _O,     _R,  _M,    _F7,
    0,   0,  0,  _equal,  _dash,
                  0,  0,
              0,  0,  0,
              0,  0,  0,
...
#define  lstick5  &kbfun_layer_sticky_5
...
const void_funptr_t PROGMEM _kb_layout_press[KB_LAYERS][KB_ROWS][KB_COLUMNS] = {
    ...
    ktrans,     kprrel,     kprrel,     kprrel,     kprrel,     kprrel,     ktrans,
    ktrans,     ktrans,     ktrans,     ktrans,     lstick5,
...
// right hand
   ...
   ktrans,   ktrans,   ktrans ),
    ...
    ktrans,     kprrel,     kprrel,     kprrel,     kprrel,     kprrel,     ktrans,
    ktrans,     kprrel,     kprrel,     kprrel,     kprrel,     kprrel,     
    ktrans,     kprrel,     kprrel,     kprrel,     kprrel,     kprrel,     lpop5,
    ktrans,     ktrans,     ktrans,     ktrans,     ktrans,
